...
def create_prometheus(
    ...
    def reload_prometheus(_):
        ...
        req = urllib.request.Request(f'https://{prometheus_host}/-/reload', method='POST')
        with urllib.request.urlopen(req):
            pass

    p.Output.all(prometheus_config_dir_resource.id, container.id).apply(reload_prometheus)
